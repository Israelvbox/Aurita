...
export function searchLocal(term, limit = 40) {
  // Si el índice está vacío (race condition con el servidor aún sincronizando),
  // devolver null para que service.js caiga al servidor/Jellyfin.
  if (!_ready || !term.trim() || _tracks.length === 0) return null;
